...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.md".freeze, "lib/betterdocs/version.rb".freeze, "lib/betterlog.rb".freeze, "lib/betterlog/event.rb".freeze, "lib/betterlog/event_formatter.rb".freeze, "lib/betterlog/log.rb".freeze, "lib/betterlog/log_event_formatter.rb".freeze, "lib/betterlog/severity.rb".freeze, "lib/betterlog/version.rb".freeze]
  s.files = ["README.md".freeze, "bin/betterlog".freeze, "lib/betterdocs/version.rb".freeze, "lib/betterlog.rb".freeze, "lib/betterlog/event.rb".freeze, "lib/betterlog/event_formatter.rb".freeze, "lib/betterlog/log.rb".freeze, "lib/betterlog/log_event_formatter.rb".freeze, "lib/betterlog/severity.rb".freeze, "lib/betterlog/version.rb".freeze]
