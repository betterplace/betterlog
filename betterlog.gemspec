...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.md".freeze, "lib/betterdocs/version.rb".freeze, "lib/betterlog.rb".freeze, "lib/betterlog/event_formatter.rb".freeze, "lib/betterlog/log.rb".freeze, "lib/betterlog/log/event.rb".freeze, "lib/betterlog/log/log_event_formatter.rb".freeze, "lib/betterlog/log/severity.rb".freeze, "lib/betterlog/version.rb".freeze]
  s.files = [".gitignore".freeze, "Gemfile".freeze, "LICENSE".freeze, "README.md".freeze, "Rakefile".freeze, "VERSION".freeze, "betterdocs.gemspec".freeze, "betterlog.gemspec".freeze, "bin/betterlog".freeze, "lib/betterdocs/version.rb".freeze, "lib/betterlog.rb".freeze, "lib/betterlog/event_formatter.rb".freeze, "lib/betterlog/log.rb".freeze, "lib/betterlog/log/event.rb".freeze, "lib/betterlog/log/log_event_formatter.rb".freeze, "lib/betterlog/log/severity.rb".freeze, "lib/betterlog/version.rb".freeze, "log.yml".freeze]
